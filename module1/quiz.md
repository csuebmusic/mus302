...
Each question is below in plain text, ready to copy one at a time. Question stem, then four answer choices labeled a through d, each on its own line. The correct answer for each is in the answer key at the very bottom of this file (do not paste the answer key into Canvas).
