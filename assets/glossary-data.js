...
,
  ...
  "tin-pan-alley": {
    label: "Tin Pan Alley",
    definition: "Both a place and an industry. As a place, Tin Pan Alley was the block of West 28th Street between Fifth and Sixth Avenues in Manhattan where most of the major American sheet-music publishing houses concentrated in the 1890s and early 1900s. As an industry, Tin Pan Alley refers to the broader sheet-music-driven popular song business of approximately 1885 to 1930, organized around publishing companies that bought songs from staff or freelance songwriters, sold them as printed sheet music for home piano use, and employed pluggers whose job was to get the songs performed in vaudeville theaters, on Broadway, in dance halls, and (after roughly 1910) on phonograph records. The publisher owned the song copyright and collected most of the income from every sale, performance, and recording; the songwriters were paid a flat fee or a small royalty share; the performers who actually made the songs famous were paid a wage for their work and received no share of the song\u2019s ongoing income. Many of the era\u2019s most prominent songwriters were children of Eastern European Jewish immigrants, including Irving Berlin, George and Ira Gershwin, Jerome Kern, and Harold Arlen; the Tin Pan Alley songbook, extended by the Broadway musicals of Rodgers and Hammerstein and others through the 1940s and 1950s, is often called the Great American Songbook. The songbook was built directly out of Black American musical material: ragtime, blues, and early jazz supplied the harmonic, rhythmic, and stylistic raw material the Tin Pan Alley songwriters reworked, and the songs reached white audiences through blackface minstrelsy and vaudeville (Berlin\u2019s 1911 \u201cAlexander\u2019s Ragtime Band,\u201d Gershwin\u2019s 1919 \u201cSwanee\u201d as Al Jolson performed it, Jolson\u2019s 1927 film The Jazz Singer). The credit and royalty dynamics of the era were racially uneven by design: Jewish songwriters and white-owned publishing companies kept the copyrights and the income while Black musicians, whose work the songs drew on and whose performance traditions the songs depended on for their sound, were largely cut out of both. Jeffrey Melnick, in A Right to Sing the Blues (Harvard, 1999), argues that this arrangement was central to how a generation of Jewish American songwriters \u201creorganized Jewishness as a species of whiteness\u201d through their engagement with Black music. The structural pattern Tin Pan Alley set up, white-owned publishers extracting income from Black musical labor, ran forward into the Brill Building system of the late 1950s and early 1960s that Track 3 of this module anchors on."
  },
  ...
  "fermata": {
    label: "Fermata",
    definition: "A music-notation symbol (a small curved arc with a dot under it, sometimes called a \u201cbird\u2019s eye\u201d) placed above a note, a chord, or a rest to indicate that it should be held longer than its written duration. How much longer is left to the performer\u2019s judgment, often shaped by the conductor in an ensemble piece. A fermata can mark the end of a phrase, sustain a moment of harmonic suspense, or signal an open-ended pause; in Bach\u2019s Brandenburg Concerto No. 3, the fermata over the second chord of the two-chord middle movement is the cue that an improvised cadenza or connective passage belongs there before the third movement begins."
  },
  ...
  "moog-synthesizer": {
    label: "Moog synthesizer",
    definition: "The family of voltage-controlled synthesizers designed and built by Robert Moog beginning in 1964, the first commercially viable synthesizer instruments and the model on which most subsequent analog synthesizer design is built. The earliest Moog instruments were large modular systems custom-assembled to each customer\u2019s specifications, with a keyboard controller, an array of oscillator, filter, envelope-generator, and amplifier modules, and a tangle of patch cords physically routing signals between them; Wendy Carlos\u2019s instrument on <em>Switched-On Bach</em> was one of these custom modular systems, built by Moog to her specifications in 1966-1967. The 1970 Minimoog packaged a stripped-down version of the modular into a portable, affordable, internally-routed instrument that became the standard working synthesizer of 1970s rock, funk, soul, jazz fusion, progressive rock, and early disco; the Polymoog (1975) and Memorymoog (1982) extended the design into polyphonic territory. The Moog ladder filter (a 24-decibel-per-octave low-pass filter with a particular resonant character) is one of the most distinctive and widely imitated sounds in the history of electronic music."
  },
  ...
  "ferruccio-busoni": {
    ...
    definition: "Italian composer, pianist, and teacher (born April 1, 1866, in Empoli, Tuscany; died July 27, 1924, in Berlin), one of the central pianist-composers of late nineteenth-century and early twentieth-century European music and a figure whose teaching lineage runs through several of the people Wendy Carlos eventually studied with. Busoni was born to a clarinetist father and a German-Italian pianist mother, was a child prodigy who debuted publicly at seven, and after Vienna Conservatory training and teaching posts in Helsinki, Moscow, and Boston settled in Berlin in 1894, where he spent most of the rest of his career as a touring pianist, conductor, editor (especially of Bach\u2019s keyboard works, in the influential Bach-Busoni Editions), composer, and teacher. During World War I he relocated to neutral Switzerland (Z\u00fcrich), and after returning to Berlin in 1920 he was appointed director of the master class in composition at the Prussian Academy of Arts. He held this position until his death in 1924; Arnold Schoenberg succeeded him in the same chair in 1925, which is the chair Schoenberg was dismissed from in 1933. Otto Luening was among Busoni\u2019s composition students in Munich and Z\u00fcrich in the 1910s. The European-modernist teaching lineage that reached American academic electronic music through Columbia-Princeton runs through Busoni\u2019s Berlin master class on more than one line."
  },

  "milton-babbitt": {
    label: "Milton Babbitt (1916\u20132011)",
    definition: "American composer and music theorist (born May 10, 1916, in Philadelphia; died January 29, 2011, in Princeton), one of the founding figures of American academic electronic music and the most prominent twentieth-century proponent of <em>total serialism</em> (an extension of Arnold Schoenberg\u2019s twelve-tone technique that organized rhythm, dynamics, and timbre as well as pitch around a fixed ordering). Babbitt taught composition at Princeton from 1938 to 1984 and at Juilliard from 1973, mentoring a generation of American composers (and, less expectedly, the Broadway lyricist Stephen Sondheim, who studied composition with him in the early 1950s). He was an early user of the RCA Mark II at the Columbia-Princeton Electronic Music Center, assumed the center\u2019s directorship in 1959, and was the most prolific composer working with the Mark II through the 1960s. Babbitt\u2019s 1958 essay, published in <em>High Fidelity</em> magazine under the editor-imposed title \u201cWho Cares If You Listen?\u201d (Babbitt\u2019s own title was \u201cThe Composer as Specialist\u201d), argued that contemporary art-music composers should accept their position as specialists writing for small expert audiences, on the model of mathematics and theoretical physics, and should not have to compromise the music\u2019s difficulty for popular reception. The essay became the canonical statement of the postwar American academic avant-garde\u2019s stance on its public, and the institutional aesthetic it defended is the aesthetic Wendy Carlos has described herself as having been trained inside at Columbia-Princeton and as having departed from with <em>Switched-On Bach</em>."
  },

  "arnold-schoenberg": {
    label: "Arnold Schoenberg (1874\u20131951)",
    definition: "Austrian-American composer and music theorist (born September 13, 1874, in Vienna; died July 13, 1951, in Los Angeles), the central figure in the early-twentieth-century development of atonality and the inventor of the <em>twelve-tone technique</em> (also called <em>dodecaphony</em>), a method of composition that ordered all twelve chromatic pitches into a fixed series and built a piece on systematic permutations of that series. Schoenberg taught composition at the Prussian Academy of Arts in Berlin from 1925 to 1933, where he succeeded Ferruccio Busoni in the master composition class. In April 1933 the Nazi regime\u2019s Law for the Restoration of the Professional Civil Service banned Jews from university positions; Schoenberg fled to Paris the following month and sailed for New York in October. He taught briefly at the Malkin Conservatory in Boston and from 1936 at the University of California, Los Angeles, until his retirement in 1944. The twelve-tone technique Schoenberg brought with him became the central compositional framework of the postwar American academic avant-garde, including Milton Babbitt\u2019s total serialism at Princeton and Columbia-Princeton; the technique\u2019s arrival in American music is one part of the broader story of the transatlantic transfer of European modernism to the United States via composer-refugees fleeing Nazi Europe in the 1930s and 1940s."
  },

  "thaddeus-cahill": {
    label: "Thaddeus Cahill (1867\u20131934)",
    definition: "American inventor and lawyer (born June 18, 1867, in Iowa; died April 12, 1934, in New York City), the inventor of the Telharmonium (also called the Dynamophone), the first significant electrical musical instrument. Cahill trained as a lawyer at George Washington University and worked as a Congressional clerk before pivoting to the Telharmonium full-time. The instrument, first patented in 1897 and built in three increasingly massive versions over the next decade, used dozens of rotating dynamo-style alternators to generate musical tones electromechanically, which were then broadcast over telephone lines as \u201cTelharmonic Music\u201d to subscribers in hotels, restaurants, and private residences. The Mark II, built in Holyoke, Massachusetts in 1902 by a team of fifty engineers, weighed nearly 200 tons and cost roughly $200,000 (over five million dollars in 2020s terms). The instrument failed commercially, partly because broadcasting electronic music over telephone lines proved technically impossible to do without crosstalk into ordinary telephone calls, partly because the rise of commercial radio broadcasting after World War I removed the market for transmission-via-telephone-line music, and partly because the Telharmonium\u2019s scale and power consumption made it unsustainable. The final unit was scrapped in 1962, and no recordings of the instrument have survived. The Telharmonium is the canonical starting point for the homegrown American tinkerer-engineer tradition of electronic music-making that runs through Theremin, Cage, and ultimately Moog."
  },

  "leon-theremin": {
    label: "Leon Theremin (1896\u20131993)",
    definition: "Russian inventor, physicist, and cellist (born Lev Sergeyevich Termen, August 27, 1896, in Saint Petersburg; died November 3, 1993, in Moscow), inventor of the theremin, one of the first electronic musical instruments and the first to be mass-produced. Theremin trained in physics and astronomy at the University of Petrograd, served as a military radio engineer during World War I, and developed the prototype of the instrument that would bear his name at the Physical Technical Institute in Petrograd in 1920; he demonstrated it for Lenin in 1922, then toured Europe and the United States with it in the mid-1920s. He arrived in New York in December 1927, patented the instrument in the United States in 1928 (US Patent 1,661,058), and licensed commercial production to RCA in 1929. During his ten years in New York, Theremin ran a studio on West 54th Street, collaborated with the composer Henry Cowell on the Rhythmicon (a polyrhythmic electronic instrument), worked with the choreographer and composer community around the Carnegie Hall scene, and married the African-American ballerina Lavinia Williams. In 1938 he returned (or, in most contemporary accounts, was kidnapped by Soviet intelligence and returned) to the Soviet Union, where he was sentenced to forced labor in the Magadan sharashka camps and subsequently put to work designing covert listening devices for the KGB; he later worked at the Moscow Conservatory and finally at the Moscow electronics institute. His instrument\u2019s influence on the synthesizer-pioneer tradition that this module covers is direct: Robert Moog built his first theremin at fourteen from plans in a 1949 hobbyist magazine and built the entire R.A. Moog Company on theremin kits sold through the same hobbyist channels before any of his synthesizer modules existed."
  },

  "john-cage": {
    label: "John Cage (1912\u20131992)",
    definition: "American composer (born John Milton Cage Jr., September 5, 1912, in Los Angeles; died August 12, 1992, in New York City), one of the most influential figures in twentieth-century experimental music. Cage studied composition with Arnold Schoenberg in Los Angeles in 1934-1935; Schoenberg told him he had no feeling for harmony and would always run into a wall, and Cage replied that he would devote his life to beating his head against that wall. (Schoenberg later said of Cage, \u201cOf course he\u2019s not a composer, but he\u2019s an inventor \u2014 of genius,\u201d a line Cage subsequently adopted.) Across the 1930s and 1940s Cage developed his characteristic interests in percussion ensembles, prepared piano (a piano with objects placed between the strings, producing percussive and pitched-and-unpitched sounds at once), and electronic devices. Cage\u2019s 1939 piece <em>Imaginary Landscape No. 1</em>, scored for two variable-speed phonographs playing test-tone records, muted piano, and cymbal, is widely cited as the first piece of live electronic music in the Western art-music tradition; it premiered at the Cornish School in Seattle on March 24, 1939. Cage\u2019s subsequent work (the long collaboration with the dancer-choreographer Merce Cunningham from 1942 onward, the indeterminacy and chance-operations approach he developed from the early 1950s, the 1952 piece <em>4\u203233\u2033</em>, the Imaginary Landscape series for radios and tape, his Zen-influenced writings on noise and silence) made him the central American avant-garde composer of the postwar period. His early electronic experimentation belongs in the same homegrown tinkerer-engineer thread as Cahill and Theremin, even though Cage worked primarily inside the academic-composer world and his electronic pieces used affordable consumer devices (turntables, radios, tape recorders) rather than custom-built instruments."
  },
  ...
  "bruce-springsteen": {
    label: "Bruce Springsteen (b. 1949)",
    definition: "American singer, songwriter, and bandleader (born Bruce Frederick Joseph Springsteen, September 23, 1949, at Monmouth Medical Center in Long Branch, New Jersey), the central figure of the heartland rock subgenre and one of the most influential American popular musicians of the late twentieth and early twenty-first centuries. Springsteen grew up in Freehold Borough, New Jersey, in a working-class Catholic family of mixed Dutch (the surname; colonial New Jersey roots), Irish (his father, mostly Irish despite the Dutch surname), and Italian (his mother, of the Zerilli family from near Naples) ancestry. He began performing on the New Jersey shore club circuit in the late 1960s and signed to Columbia Records in 1972; with the E Street Band he built a recording career on a series of albums (<em>Born to Run</em> 1975, <em>Darkness on the Edge of Town</em> 1978, <em>The River</em> 1980, <em>Nebraska</em> 1982, <em>Born in the U.S.A.</em> 1984) that anchored heartland rock and that placed white working-class American life, deindustrialization, the Vietnam War and its veterans, the lives of immigrant communities, and the gap between American promise and American reality at the center of the genre\u2019s subject matter. Springsteen has consistently named the Italian American crooner tradition (Frank Sinatra above all) and the doo-wop and R&amp;B he heard on the radio as a Jersey teenager as foundational for his own vocal and arrangement instincts. <em>The River</em>\u2019s title track is the anchor for Module 5\u2019s closing listening guide."
  },

  "e-street-band": {
    label: "E Street Band",
    definition: "Bruce Springsteen\u2019s longtime backing band, formed in 1972 and named in September 1974 after the East Orange, New Jersey street where keyboardist David Sancious\u2019s mother lived (and where the band rehearsed in the early years). The band\u2019s long-term core lineup runs Roy Bittan (piano), Clarence Clemons (saxophone, 1972\u20132011), Danny Federici (organ, 1972\u20132008), Garry Tallent (bass), Steven Van Zandt (guitar, on and off across the band\u2019s history), Nils Lofgren (guitar, from 1984), Patti Scialfa (vocals, from 1984; married to Springsteen since 1991), and Max Weinberg (drums). The band\u2019s sonic vocabulary (piano and organ across the keyboard space, saxophone as the lead melodic voice, bass and drums driving but unflashy, two electric guitars) is one of the most recognizable in late-twentieth-century American rock and is foundational to the heartland rock genre."
  },

  "the-river-album": {
    label: "The River (Bruce Springsteen, 1980)",
    definition: "Bruce Springsteen\u2019s fifth studio album, released as a double LP on October 17, 1980 on Columbia Records. Produced by Springsteen with his manager Jon Landau and bandmate Steven Van Zandt; recorded with the E Street Band at the Power Station in New York City over eighteen months (March 1979 through May 1980); engineered by Neil Dorfsman and Bob Clearmountain; mixed by Bob Clearmountain, Chuck Plotkin, and Toby Scott at Clover Recorders in Los Angeles. Twenty songs across four LP sides, alternating fast rock-and-roll party songs (\u201cThe Ties That Bind,\u201d \u201cSherry Darling,\u201d \u201cI\u2019m a Rocker,\u201d \u201cHungry Heart,\u201d \u201cCadillac Ranch,\u201d \u201cRamrod,\u201d \u201cOut in the Street\u201d) with slower introspective ballads (\u201cIndependence Day,\u201d \u201cPoint Blank,\u201d the title track, \u201cStolen Car,\u201d \u201cWreck on the Highway\u201d) that previewed the direction Springsteen\u2019s next album <em>Nebraska</em> (1982) would take. <em>The River</em> was Springsteen\u2019s first number-one album on the US Billboard 200 and is widely identified as one of the central popular-music documents of the late-1970s and early-1980s deindustrialization moment."
  },

  "power-station-studio": {
    label: "Power Station Studios",
    definition: "A recording studio at 441 West 53rd Street in Manhattan, opened in 1977 by engineer Tony Bongiovi in a converted Consolidated Edison electrical-substation building (the name was meant literally). The room\u2019s high ceilings, large live-tracking floor, and Neve recording consoles made it a favored space for late-1970s and early-1980s rock recording with an emphasis on live-band tracking. Springsteen recorded most of <em>The River</em> there across 1979 and 1980; other major Power Station projects of the same era include albums by Diana Ross, the Rolling Stones, Bryan Ferry, Bon Jovi, Mick Jagger, and David Bowie. The studio was renamed Avatar Studios in 1996 after a change of ownership and continued to operate under that name."
  },

  "muse-no-nukes": {
    label: "MUSE / No Nukes concerts (1979)",
    definition: "Musicians United for Safe Energy, an anti-nuclear-power benefit organization founded in 1979 by Jackson Browne, Graham Nash, Bonnie Raitt, and John Hall in the wake of the Three Mile Island partial nuclear meltdown (March 28, 1979) in Pennsylvania. MUSE produced a five-night benefit concert series at Madison Square Garden in New York City, September 19 through 23, 1979, with proceeds funding renewable-energy advocacy; performers included Browne, Nash, Raitt, Hall, James Taylor, Carly Simon, Crosby Stills and Nash, the Doobie Brothers, Tom Petty and the Heartbreakers, and Bruce Springsteen and the E Street Band. The concert series was filmed and released as the 1980 documentary <em>No Nukes</em> and as a triple-LP soundtrack album. Springsteen and the E Street Band played the September 21 and 22 shows; the September 21 set was the first public performance of \u201cThe River,\u201d roughly thirteen months before the album\u2019s release."
  },

  "early-1980s-recession": {
    label: "Early-1980s recession",
    definition: "A double-dip economic downturn in the United States and across much of the industrialized world, running in two phases: a first phase from January through July 1980, triggered by the 1979 oil shock (in turn triggered by the Iranian Revolution and the subsequent disruption of Iranian oil exports), and a second deeper phase from July 1981 through November 1982. The combined recession was the worst American economic contraction since the Great Depression of the 1930s, with peak unemployment above ten percent in 1982 and rates of inflation above ten percent across 1979 and 1980 (the combination is the \u201cstagflation\u201d economists named at the time). The recession\u2019s effects were not evenly distributed: manufacturing, construction, and heavy industry in the Northeast and Midwest were hit much harder than the service economy, and the decade-long deindustrialization that had been underway in the steel, auto, rubber, and textile sectors accelerated. <em>The River</em> was written and recorded during the first phase and released three weeks before the November 1980 election that brought Ronald Reagan to the White House."
  },

  "rust-belt": {
    label: "Rust Belt",
    definition: "An informal term for the heavy-industry manufacturing region of the American Northeast and Midwest (running across western New York, Pennsylvania, Ohio, Indiana, Michigan, northern Illinois, and adjacent areas) that experienced severe industrial decline from the 1970s onward, as the steel, automobile, rubber, and machine-tool industries that had built the region\u2019s mid-twentieth-century working-class economy contracted, automated, or relocated. The term came into wide use in the early 1980s; the prior \u201cSteel Belt\u201d and \u201cManufacturing Belt\u201d designations had emphasized what the region produced, the new \u201cRust Belt\u201d label what its closed factories were doing. The deindustrialization that produced the Rust Belt is one of the central historical conditions of late-1970s and 1980s American popular music, audible in heartland rock above all but also in punk, hip hop, and 1980s Detroit techno."
  },

  "johnstown-pennsylvania": {
    label: "Johnstown, Pennsylvania",
    definition: "A small industrial city in western Pennsylvania, about seventy miles east of Pittsburgh in the Allegheny Mountains, built on the nineteenth-century coal and iron industries and on the Bethlehem Steel works that operated continuously from 1858 through the 1990s. Johnstown was a major center of central- and eastern-European Catholic immigration in the 1880\u20131924 period (substantial Polish, Slovak, Hungarian, Croatian, Slovenian, and Italian populations), with the steel mills and coal mines as the principal employers. The 1977 Johnstown flood (a third major flood after the catastrophic 1889 and 1936 floods) closed several Bethlehem Steel facilities for months and accelerated the long contraction of the company\u2019s Johnstown operations through the 1980s. Springsteen\u2019s reference to \u201cthe Johnstown Company\u201d in the lyric of \u201cThe River\u201d is generic, an invented employer name rather than the real Bethlehem Steel or any specific Johnstown firm; the city\u2019s national reputation by 1980 as a heavy-industry town in serious trouble is what the lyric reaches for."
  },

  "harmonica": {
    label: "Harmonica",
    definition: "A small free-reed wind instrument, played by blowing and drawing air across a row of metal reeds tuned to a particular key. The standard diatonic harmonica (also called a blues harp or Mississippi saxophone) has ten holes, each yielding two pitches (one for blowing, one for drawing), and is tuned to a single major key; cross-harp playing, where the player works in a key a fifth above the harmonica\u2019s home key, accesses the bent and \u201cblue\u201d notes characteristic of blues and country harmonica vocabulary. The instrument was mass-produced in Germany from the 1850s forward (the Hohner company at Trossingen is the canonical maker) and traveled to the United States as both an immigrant household instrument and a cheap, portable solo instrument; it became central to country blues, Chicago blues (Little Walter, Sonny Boy Williamson I and II, James Cotton), country music, folk revival (Bob Dylan, Neil Young), and rock (Bruce Springsteen, John Popper). Springsteen plays cross-harp on \u201cThe River\u201d in the key of D, the harmonica itself tuned to G."
  },

  "new-deal": {
    label: "New Deal",
    definition: "The set of federal programs, public-works projects, financial reforms, and labor and social-welfare laws enacted in the United States between 1933 and 1938 under President Franklin D. Roosevelt, in response to the economic collapse of the Great Depression. Major elements include the Social Security Act of 1935 (which established the federal old-age pension and unemployment insurance systems), the National Labor Relations Act (Wagner Act) of 1935 (which legally protected the right of workers to organize unions and bargain collectively, and which produced the surge in union membership that built the postwar industrial working class), the Fair Labor Standards Act of 1938 (which established a federal minimum wage and the forty-hour work week and banned child labor in covered industries), and dozens of agencies and programs including the Works Progress Administration, the Tennessee Valley Authority, the Federal Housing Administration, and the Civilian Conservation Corps. The New Deal\u2019s benefits were unevenly distributed by design: agricultural and domestic workers (categories that disproportionately covered Black and Mexican American labor in the 1930s) were excluded from many of the new protections, and the Federal Housing Administration\u2019s mortgage program was structured around the racially exclusionary redlining maps the agency itself produced. The New Deal nonetheless built the institutional infrastructure of the postwar American working-class economy and is the political-economic ground most twentieth-century American working-class popular musics, including the heartland rock Springsteen anchors, eventually sat on top of."
  },
