...
- Initial post: due by Sunday, June 7 (the Module 2 deadline)
- Two assigned responses: due by Sunday, June 14
...
Setup in Canvas: post the discussion as usual, set initial-post deadline to Sunday, June 7 and the peer-response deadline to Sunday, June 14, then enable the discussion's peer-review feature to assign two responses per student automatically after the initial-post deadline. Verify before the deadline that peer-review is set to "automatic" rather than "manual" so the assignments fire on the deadline.
