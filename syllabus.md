...
Summer 2026, May 26 to July 31. Inés Thiebaut.

| | |
|---|---|
| Units | 3 |
| Breadth Area | GE-UD-3 (Upper Division Arts or Humanities) |
| Overlay | Diversity |
...
Inés Thiebaut. Email ines.thiebaut@csueastbay.edu. Office hours Wednesdays 1 to 3 pm, in person in MB2012 or by Zoom at https://csueb.zoom.us/j/5108853126. If you cannot make those times, email me and we will coordinate another. I would rather hear from you early than late.
...
I encourage you to communicate with me regularly and early. I maintain an open-door policy whenever I am in my office: feel free to stop by with questions, concerns, or to talk through ideas.
...
This course is organized into six Canvas modules and a parallel research project. The structure is designed to give you flexibility while keeping us moving through the term together.
...
Modules 2 through 5 cover the four cultural traditions. Once you finish Module 1, all four become available at the same time. You may complete them in any order that interests you. All four must be complete by the end of the window listed in the schedule below.

Module 6 (Cross-Cutting Threads and Synthesis) becomes available after Modules 2 through 5 are complete. It draws connections across the traditions you have studied and turns to Indigenous popular music and queer liberation as threads that run through and beyond the previous modules.

Each module includes assigned listening, short readings or videos, a discussion contribution, and a low-stakes checkpoint quiz that focuses on factual recall (artists, dates, key works, key contexts). Modules are self-contained, which means you can work through them at your own pace within the windows set in the schedule.
...
Each of the six modules includes a checkpoint quiz, a discussion contribution, and short response work tied to the module's listening. Modules are self-contained and can be completed at your own pace within the windows in the schedule below.

### Discussion

Discussion happens both inside modules (one thread per module that stays open the whole term) and through periodic cross-cutting prompts that ask you to bring an example from any module you have completed so far. Discussion is where we hear each other think about this music. You will be expected to post your own contributions and respond to classmates.

### Final project: genre and artist research presentation

In place of a final exam, you will research a genre and a single artist or group of personal significance to you, and present your work as a PowerPoint deck with recorded video commentary. You will submit two files: the standalone deck (PowerPoint, Google Slides exported to .pptx, or Keynote exported to .pptx), and a screen recording in which you walk through your slides and present your argument in your own voice.
...
- **Final project** (scaffolded across the term): 40%
- **Module completion and checkpoint quizzes**: 30%
- **Discussion**: 20%
